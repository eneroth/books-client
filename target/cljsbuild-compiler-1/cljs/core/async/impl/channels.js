...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14745 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14745 = (function (val,box,meta14746){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14745.cljs$lang$type = true;
cljs.core.async.impl.channels.t14745.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14745";
cljs.core.async.impl.channels.t14745.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write(writer__3971__auto__,"cljs.core.async.impl.channels/t14745");
});
cljs.core.async.impl.channels.t14745.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14745.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14747){var self__ = this;
var _14747__$1 = this;return self__.meta14746;
});
cljs.core.async.impl.channels.t14745.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14747,meta14746__$1){var self__ = this;
var _14747__$1 = this;return (new cljs.core.async.impl.channels.t14745(self__.val,self__.box,meta14746__$1));
});
cljs.core.async.impl.channels.__GT_t14745 = (function __GT_t14745(val__$1,box__$1,meta14746){return (new cljs.core.async.impl.channels.t14745(val__$1,box__$1,meta14746));
});
}
return (new cljs.core.async.impl.channels.t14745(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14748 = self__.takes.pop();if((taker_14748 == null))
{} else
{if(taker_14748.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_14749 = taker_14748.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_14749,taker_14748){
return (function (){return (take_cb_14749.cljs$core$IFn$_invoke$arity$1 ? take_cb_14749.cljs$core$IFn$_invoke$arity$1(null) : take_cb_14749.call(null,null));
});})(take_cb_14749,taker_14748))
);
} else
{}
{
