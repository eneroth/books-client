...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14716 = 0;while(true){
if((i_14716 < arr.length))
{(arr[i_14716] = null);
{
...
{var i_14723 = (self__.level + 1);while(true){
if((i_14723 <= (new_level + 1)))
{(update[i_14723] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14725 = 0;while(true){
if((i_14725 <= self__.level))
{var links_14726 = (update[i_14725]).forward;if(((links_14726[i_14725]) === x__$1))
{(links_14726[i_14725] = (x__$1.forward[i_14725]));
{
var G__14727 = (i_14725 + 1);
i_14725 = G__14727;
continue;
}
} else
{{
var G__14728 = (i_14725 + 1);
i_14725 = G__14728;
continue;
}
}
